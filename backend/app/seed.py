...
def seed():
    ...
    db.add(m.User(username="admin", full_name="Programme Admin", password_hash=hash_password("admin123"), role="admin"))
    db.add(m.User(username="enumerator1", full_name="Enum. K. Prasad", password_hash=hash_password("field123"), role="enumerator"))
    db.add(m.User(username="enumerator2", full_name="Enum. S. Nayak", password_hash=hash_password("field123"), role="enumerator"))
    db.commit()
