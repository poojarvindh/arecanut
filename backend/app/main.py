...
from .schemas import SurveyIn, SurveyOut, FarmerLookup, LoginIn, TokenOut, UserOut
from .auth import verify_password, create_access_token, get_current_user, require_role

Base.metadata.create_all(bind=engine)

app = FastAPI(title="Arecanut Farmer Data Collection API")
...
def list_surveys(
    ...
    return query.order_by(m.FarmerSurvey.entry_timestamp.desc()).all()
